...
This section demonstrates how PHOENIX can be used to calculate the linear response of microresonator systems. The example shows how exceptional rings emerge in spin-orbit coupled planar microresonators exhibiting circular dichroism. [paper link is about to be added]
